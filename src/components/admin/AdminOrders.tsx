...
export const AdminOrders: React.FC = () => {
  ...
  const getStatusBadge = (status: OrderStatus) => {
    switch (status) {
      case 'delivered':
        return <Badge variant="outline" className="text-emerald-700 border-emerald-200 bg-emerald-50 text-[10px] uppercase font-medium">Delivered</Badge>;
      case 'shipped':
      case 'out_for_delivery':
        return <Badge variant="outline" className="text-blue-700 border-blue-200 bg-blue-50 text-[10px] uppercase font-medium">In Transit</Badge>;
      case 'processing':
      case 'confirmed':
        return <Badge variant="outline" className="text-amber-700 border-amber-200 bg-amber-50 text-[10px] uppercase font-medium">Processing</Badge>;
      case 'cancelled':
        return <Badge variant="outline" className="text-rose-700 border-rose-200 bg-rose-50 text-[10px] uppercase font-medium">Cancelled</Badge>;
      default:
        return <Badge variant="outline" className="text-[10px] uppercase font-medium">{status}</Badge>;
    }
  };
              ...
              {filteredOrders.map(order => (
                ...
                >
                  <td className="py-3 px-4">
                    <span className="font-medium text-slate-900 block">{order.orderNumber}</span>
